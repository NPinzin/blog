  ...
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      <div class="col-4 pt-1">
        <a class="btn btn-sm btn-outline-secondary" href="registration.php">Logout</a>
        <a class="link-secondary" href="registration.php" style="padding-left: 10px">Profile</a>
      </div>
      <div class="col-4 text-center">
        <a class="blog-header-logo text-dark" href="index.php">Blonk</a>
      </div>
      <div class="col-4 d-flex justify-content-end align-items-center">
        <a class="link-secondary" href="registration.php" aria-label="Search">
...
<main class="container">
  <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark" id="header">
    <div class="col-md-6 px-0">
      <!-- <img src="blonk-high-resolution-color-logo.png" height="100%" width="100%" id="header-logo"> -->
      ...
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" >
        ...
        // selecting posts
          ...
          $row = mysqli_fetch_array($postResult);
              ...
              <a href='registration.php'>Continue reading</a>
              </div>";
        ?>
        </div>
      ...
      <h3 class="pb-4 mb-4 fst-italic border-bottom">
        ...
        // selecting posts
          ...
          while($row = mysqli_fetch_array($postResult)){
              ...
              $author = $row['firstName'] . " ". $row['lastName'];
              // Creating HTML structure
              echo "<div id='post_".$id."' class='post' style='overflow: auto;'onclick='location.href=`registration.php`' style='cursor:pointer'>
